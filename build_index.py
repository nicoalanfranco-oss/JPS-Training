...
<style>
    ...
    @keyframes heroBgEntry {
        0%   { filter: grayscale(0%) brightness(1.3) saturate(1.4); opacity: 1;  transform: scale(1.08); }
        60%  { filter: grayscale(0%) brightness(1.1) saturate(1.1); opacity: 0.9; transform: scale(1.04); }
        100% { filter: grayscale(80%)  brightness(0.9) saturate(0.3); opacity: 0.45; transform: scale(1); }
    }
    .hero-bg-anim { animation: heroBgEntry 8s cubic-bezier(0.2, 0.8, 0.2, 1) forwards; }
    ...
    @keyframes pulseSocial {
        ...
        50% { box-shadow: 0 12px 35px rgba(37,211,102,0.7), 0 0 0 8px rgba(37,211,102,0); }
    }
    @keyframes pulseIG {
        0%, 100% { box-shadow: 0 8px 25px rgba(225,48,108,0.5), 0 0 0 0 rgba(225,48,108,0.4); }
        50% { box-shadow: 0 12px 35px rgba(225,48,108,0.7), 0 0 0 8px rgba(225,48,108,0); }
    }
    .social-btn {
    ...
    .social-btn:hover { transform: scale(1.18) translateY(-3px) !important; filter: drop-shadow(0 10px 24px rgba(0,0,0,0.7)) brightness(1.1); }
    .social-btn-wa { background: linear-gradient(145deg, #25d366, #128c7e); animation: floatSocial 3s ease-in-out infinite, pulseSocial 2.5s ease-in-out infinite; }
    .social-btn-ig { background: linear-gradient(145deg, #f09433 0%, #e6683c 25%, #dc2743 50%, #cc2366 75%, #bc1888 100%); animation: floatSocial 3.4s ease-in-out infinite, pulseIG 2.8s ease-in-out infinite; animation-delay: 0.4s; }
...
<div class="flex justify-between items-center px-16 h-20 w-full max-w-7xl mx-auto">
    ...
    <div class="flex items-center gap-4">
        <!-- WhatsApp -->
        <a href="https://api.whatsapp.com/send?phone=59898859708" class="social-btn social-btn-wa" title="Escribinos por WhatsApp">
        ...
        <!-- Instagram -->
        <a href="https://www.instagram.com/jpstraining.tbo/" target="_blank" rel="noopener" class="social-btn social-btn-ig" title="Seguinos en Instagram">
...
<!-- ═══════════ HERO ═══════════ -->
<section class="relative w-full h-[60vh] md:h-[85vh] min-h-[450px] md:min-h-[600px] flex items-center justify-center overflow-hidden">
    ...
    <div class="relative z-20 flex flex-col items-center justify-center text-center px-6 w-full max-w-5xl mx-auto mt-16 md:mt-32">
        ...
        <div class="flex items-center justify-center gap-3 sm:gap-6 md:gap-12 w-full">
            <!-- Left Logo -->
            <div class="logo-entry-left w-16 h-16 sm:w-24 sm:h-24 md:w-40 md:h-40 rounded-full overflow-hidden shadow-[0_0_30px_rgba(255,138,0,0.3)] border-2 md:border-4 border-[#FF8A00]/40 bg-surface-elevated flex items-center justify-center transform hover:scale-105 transition-transform duration-500 flex-shrink-0">
            ...
            <!-- Right Logo -->
            <div class="logo-entry-right w-16 h-16 sm:w-24 sm:h-24 md:w-40 md:h-40 rounded-full overflow-hidden shadow-[0_0_30px_rgba(255,138,0,0.3)] border-2 md:border-4 border-[#FF8A00]/40 bg-surface-elevated flex items-center justify-center transform hover:scale-105 transition-transform duration-500 flex-shrink-0">
                <img alt="JPS Training Logo" class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuCYp_jqKD1QU0NOJdbPFTWGg4dmxmGhsfU5zLEf_Jnv1cX5uIFI9v7qXpbtzu6i84ub2uOgn3rkR2uWM9tzj3so3de0NBp-Hab2mXbehmbTPxPJ4dgSJPOrSwiO12WCOIYwxeDBBWY-L7Jw4SW5tPJ0bcSdYpI2hWouDpv1jKcIB9mOltaQB0pb0r2NnyO7o52WTqrTzH87-Ey_Oi_0VcqD2eKFlGxSYTa6HgVl9qSI_f679lsNaH3efW1-R3kVPU1DcPs"/>
            </div>
        </div>
    </div>
...
<div class="max-w-4xl mx-auto">
    <div class="section-title mb-10 flex flex-col items-center md:items-start text-center md:text-left">
        ...
        <div class="w-full mt-10 mb-8 p-8 rounded-2xl bg-surface-elevated border border-brushed-metal hover:border-electric-orange transition-colors flex flex-col md:flex-row items-center justify-center gap-4 text-center md:text-left shadow-2xl">
            <a href="https://api.whatsapp.com/send?phone=59898859708" class="bg-gradient-to-br from-[#e1e4e8] via-[#bdc3c7] to-[#8e949b] shadow-[inset_0_2px_4px_rgba(255,255,255,0.7),0_8px_20px_rgba(0,0,0,0.4)] border-2 border-white p-4 rounded-full flex-shrink-0 hover:scale-110 transition-transform flex items-center justify-center group" title="Contactar por WhatsApp">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#128C7E" width="40" height="40" class="group-hover:fill-[#075E54] transition-colors drop-shadow-md">
                    <path d="M17.472 14.382c-.297-.149-1.758-.867-2.03-.967-.273-.099-.471-.148-.67.15-.197.297-.767.966-.94 1.164-.173.199-.347.223-.644.075-.297-.15-1.255-.463-2.39-1.475-.883-.788-1.48-1.761-1.653-2.059-.173-.297-.018-.458.13-.606.134-.133.298-.347.446-.52.149-.174.198-.298.298-.497.099-.198.05-.371-.025-.52-.075-.149-.669-1.612-.916-2.207-.242-.579-.487-.5-.669-.51-.173-.008-.371-.01-.57-.01-.198 0-.52.074-.792.372-.272.297-1.04 1.016-1.04 2.479 0 1.462 1.065 2.875 1.213 3.074.149.198 2.096 3.2 5.077 4.487.709.306 1.262.489 1.694.625.712.227 1.36.195 1.871.118.571-.085 1.758-.719 2.006-1.413.248-.694.248-1.289.173-1.413-.074-.124-.272-.198-.57-.347m-5.421 7.403h-.004a9.87 9.87 0 01-5.031-1.378l-.361-.214-3.741.982.998-3.648-.235-.374a9.86 9.86 0 01-1.51-5.26c.001-5.45 4.436-9.884 9.888-9.884 2.64 0 5.122 1.03 6.988 2.898a9.825 9.825 0 012.893 6.994c-.003 5.45-4.437 9.884-9.885 9.884m8.413-18.297A11.815 11.815 0 0012.05 0C5.495 0 .16 5.335.157 11.892c0 2.096.547 4.142 1.588 5.945L.057 24l6.305-1.654a11.882 11.882 0 005.683 1.448h.005c6.554 0 11.89-5.335 11.893-11.893a11.821 11.821 0 00-3.48-8.413z"/>
                </svg>
            </a>
            <div>
...
<div id="modal-juanpablo" class="staff-modal">
    <div class="staff-modal-content group">
        ...
        <div class="absolute inset-0 bg-gradient-to-t from-background from-0% via-background/90 via-30% to-transparent to-50% z-10 rounded-2xl"></div>
        <span class="close-btn z-50">&times;</span>
